 ...
 */
public class ClassifierNeuralNetwork {
    //MultilayerPerceptron
    private Classifier cl;
    private boolean clExist;
    private static final Logger log = Logger.getLogger(ClassifierNeuralNetwork.class);
    public ClassifierNeuralNetwork() {
    ...
    public Instances evalClassifier(File fileName, String resPath) {
        ...
        try {
            ...
            String fileRes = resPath + "NeuralNetworkEvaluation.txt";
    ...
    public Instances insClassify(File fileName, String resPath) {
        ...
        try {
            ...
            String outputFilePath = resPath + "NeuralNetworkClassifyResult.txt";
