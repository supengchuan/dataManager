...
public class Statistics {
    ...
    public static double getVariance(double[] inputData) {
        ...
        for (int i = 0; i < inputData.length; i++) {
            sum += Math.pow(inputData[i] - average, 2);
        }
        double result;
        result = sum / count;
    ...
    public static double getStandardDiviation(double[] inputData) {
        double result;
        //绝对值化很重要
        result = Math.sqrt(getVariance(inputData));

        return result;

    }

    public static double getSampleVariance(double[] inputData) {
        int count = getCount(inputData);
        if (count == 1)
            return 0;
    ...
    public static double getSampleStandardDiviation(double[] inputData) {
        double result;
        //绝对值化很重要
        result = Math.sqrt(getSampleVariance(inputData));
